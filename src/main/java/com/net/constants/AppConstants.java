...
public class AppConstants {
	...
	public static final String PLAN_SAVED ="planSaveSucc";
	
	public static final String PLAN_SAVE_FAIL ="planSaveFail";
	
	public static final String PLAN_UPDATED_SUCC = "planUpdatedSucc";
	
	public static final String PLAN_UPDATED_FAIL = "planUpdatedFailed";
